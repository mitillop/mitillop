...
def main():
    ...
    year_now = datetime.now(ZoneInfo("America/Tijuana")).strftime("%Y")
    t.gen_text("GIF_OS Modular BIOS v1.0.11", 1)
    t.gen_text(f"Copyright (C) {year_now}, \x1b[31mMitillop Softwares Inc.\x1b[0m", 2)
    ...
    t.gen_typing_text("mitillop", 3, contin=True)
    ...
    t.toggle_show_cursor(False)
    time_now = datetime.now(ZoneInfo("America/Tijuana")).strftime(
        "%a %b %d %I:%M:%S %p %Z %Y"
    )
    t.gen_text(f"Last login: {time_now} on tty1", 6)
    t.set_prompt("\x1b[91mmitillop\x1b[97m@\x1b[93mreadme ~>\x1b[0m")
    ...
    git_user_details = gifos.utils.fetch_github_stats("mitillop")
    user_age = gifos.utils.calc_age(28, 12, 2004)
    t.clear_frame()
    top_languages = [lang[0] for lang in git_user_details.languages_sorted]
    user_details_lines = f"""
    \x1b[30;101mmitillop@GitHub\x1b[0m
    --------------
    \x1b[96mOS:     \x1b[93mWindows 11, Android 14\x1b[0m
    \x1b[96mHost:   \x1b[93mAutonomus University Of Baja California \x1b[0m
    \x1b[96mKernel: \x1b[93mSoftware And Emerging Technologies Engineer \x1b[0m
    \x1b[96mUptime: \x1b[93m{user_age.years} years, {user_age.months} months, {user_age.days} days\x1b[0m
    \x1b[96mIDE:    \x1b[93mVSCode, IntelliJ\x1b[0m
    
    \x1b[30;101mContact:\x1b[0m
    --------------
    \x1b[96mEmail:      \x1b[93msolanomezaangel@gmail.com\x1b[0m
    \x1b[96mLinkedIn:   \x1b[93mDaniel Solano\x1b[0m
    ...
    t.gen_typing_text(" -u mitillop", 1, contin=True)
